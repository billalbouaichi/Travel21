...
$infovoyage = plussurvoyage();
$infoperssone = information();

if (isset($_POST["reserver"])) {
    if (!empty($_POST)) {
        
       $ajouter=ajoutreservation();
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../css/connexioncss.css"><!--le meme css que connexion.php-->
...
<div class="cover">
    ...
    <div class="centre">
        ...
        <div class="cnx">
            ...
            <input type="text" value="<?= $infovoyage["id"] ?>" name="idvoy" hidden>
            ...
            <input type="text" value="<?= $infovoyage["pays"] ?>" name="pays" hidden>
            <input type="date" value="<?= $infovoyage["datedpr"] ?>" name="dated" id="dd" hidden>


                <div class="form-floating" style="margin-bottom: 7px; margin-top: 50px;" >
                    <input type="number" class="form-control" name="pass" id="floatingInput1" placeholder="" required>
                    <label for="floatingInput1" id="floatingInputlabel">numero passport</label>
                </div>
                <div class="form-floating">
                    <input type="text" class="form-control" name="place" id="floatingInput2" maxlength="1" required>
                    <label for="floatingInput2" id="floatingInputlabel">nombre de place</label >
                </div>

                <label id="floatingInputlabel"><b>date de paiment</b></label>
                <div class="form-floating" style="margin-bottom: 23px;">
                    <input type="text" class="form-control" name="datep" id="floatingInput" placeholder="" required>
                    <label for="floatingInput2" id="floatingInputlabel">date de paiment</label >
                </div>
               

               
                
                <button class="w-100 btn btn-lg btn-primary" id="btncnx" type="submit" name="reserver" >reserver</button>
